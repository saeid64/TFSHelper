...
namespace TFSHelper.Build.Activities
{
    ...
    public class BuildNumberAlteration : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            var buildNumber = buildDetails.BuildNumber;
            ...
            var versionNumberPartedJoined = string.Format("{0}.{1}.{2}.{3}", versionNumberByPart[0],
                versionNumberByPart[1],
